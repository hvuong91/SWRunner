...
namespace SWRunner.Rewards
{
    public class Rune : Reward
    {
        ...
        public enum RUNESET { VIOLENT, RAGE, ENERGY, FATAL, SWIFT, FOCUS, DESPAIR, ENDURE, GUARD, BLADE, SHIELD,
            REVENGE, WILL, NEMESIS, VAMPIRE, DESTROY, FIGHT, TOLERANCE, ENHANCE, DETERMINATION, ACCURACY, UNKNOWN, ALL}

        public enum RARITY { NORMAL, RARE, MAGIC, HERO, LEGENDARY, UNKNOWN, ALL}
    }
