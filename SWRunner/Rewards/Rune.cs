...
namespace SWRunner.Rewards
{
    public class Rune : Reward
    {
        ...
        public enum RUNESET { VIOLENT, RAGE, ENERGY, FATAL, SWIFT, FOCUS, DESPAIR, ENDURE, GUARD, BLADE,
            REVENGE, WILL, NEMESIS, VAMPIRE, DESTROY, FIGHT, TOLERANCE, ENHANCE, DETERMINATION, ACCURACY, UNKNOWN}
